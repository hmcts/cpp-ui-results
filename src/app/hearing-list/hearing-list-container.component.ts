...
@Component({
  ...
  templateUrl: 'hearing-list-container.component.html',
  styleUrls: ['./hearing-list-container.component.scss'],
  imports: [
    PdkGridComponent,
    PdkMarginDirective,
    PdkTypographyDirective,
...
export class HearingListContainerComponent implements OnInit {
